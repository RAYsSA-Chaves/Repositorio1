#Gerar um arquivo .xls a partir de um dicionário de dados

historico_pedidos = [ {'ID': 1, 'Nome': 'João', 'Endereço': 'Rua das Flores, 123', 'Produto': 'Camiseta', 'Quantidade': 2, 'Preço': 50, 'Data': '01/01/2023'},
...
#Ler o dicionário
df = pandas.DataFrame(historico_pedidos)  #DataFrame lê o arquivo e converte em formato de tabela automaticamente
